...
Pour améliorer la robustesse du modèle, nous avons ajouté des obstacles aléatoires sur le circuit. Ces obstacles sont des blocs cubiques. Ils sont placés aléatoirement sur le circuit à chaque réinitialisation de la voiture. Leurs positions sont choisies aléatoirement parmis une liste de positions prédéfinies. 
\vspace{0.5cm}
...
\begin{lstlisting}
indexes = random.sample(range(0,len(obstacles_positions)), 15)
\end{lstlisting}
